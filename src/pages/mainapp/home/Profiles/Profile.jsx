            ...
            <div className="innermainbox">
                <div className="name-dp-id">
                    ...
                    <div className="name-id">
                        ...
                        {
                            mydetails?._id ===userinfo?._id ? <button data-bs-toggle="modal" data-bs-target="#editprofilemodal" onClick={()=>{changepage(5)}}>Edit Profile</button> : (userinfo?.following.includes(mydetails?._id)) ? <button>Follow Back</button> :(myinfo?.following.includes(userinfo?._id) ?  <button >UnFollow</button> : <button onClick={followaccount}>Follow</button> )
                        }
                ...
                <div className="follow-unfollow-buttons">
                    ...
                    <div className='profiledetails'>
                        ...
                        <button>Posts <span>{userinfo?.totalposts}</span></button>
                    </div>
